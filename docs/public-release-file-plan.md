...
- `include_pending_final_review`: tracked Unity asset files under retain-candidate folders. These still need final ownership review before publication.
...
This plan is a staging aid, not a release approval. The repository must stay private until the release audit has no blockers.
