...
| Resolve Unity third-party asset rights | blocked | `docs/third-party-assets.md`, `docs/asset-removal-plan.md`, `docs/asset-disposition-tracker.md`, `docs/unity-external-imports.md`, `docs/public-asset-manifest.md`, `docs/inventory/unity-asset-audit.csv`, `docs/inventory/unity-risky-asset-references.csv`, `docs/inventory/unity-asset-replacement-worklist.csv`, `docs/inventory/unity-public-asset-manifest.csv`, `docs/inventory/unity-asset-disposition.csv`, `docs/inventory/unity-external-imports.csv`, `tools/export-unity-asset-replacement-worklist.ps1`, `tools/export-public-asset-manifest.ps1` | Every asset disposition row has a non-`pending` decision, retained assets have documented rights, and Unity validation still passes. |
