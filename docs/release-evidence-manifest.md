...
1. Resolve GitHub issues #2 and #5. Issues #1 and #3 are no longer release blockers under the 2026-06-20 scope update unless the user reopens NAS or interactive VR smoke testing as required work.
