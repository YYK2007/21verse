...
Generated: 2026-06-19 23:31:35 +03:00
...
| Release evidence manifest | blocker | 8 release requirements tracked; 2 requirements are blocked: Review attached NAS Youssef Storage (#1); Resolve Unity third-party asset rights (#2). | Resolve or document every blocked release requirement before changing visibility. |
