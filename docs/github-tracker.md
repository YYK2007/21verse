...
| #2 | `docs/third-party-assets.md`, `docs/asset-removal-plan.md`, `docs/asset-disposition-tracker.md`, `docs/public-asset-manifest.md`, `docs/inventory/unity-asset-disposition.csv`, `docs/inventory/unity-public-asset-manifest.csv` | Nine Unity asset disposition rows are still `pending`; the public asset manifest marks five folders for external import/rights confirmation and four folders for replacement before public release. |
...
| #2 | `docs/third-party-assets.md`, `docs/asset-disposition-tracker.md`, `docs/public-asset-manifest.md`, `docs/inventory/unity-asset-disposition.csv`, `docs/inventory/unity-public-asset-manifest.csv` |
